...
public class ToolController {
    ...
    public DataResponse uploadFile(HttpServletRequest request, @PathVariable String type) {
        ...
        for (MultipartFile file : files) {
            if (!file.isEmpty()) {
                try {
                    ...
                    return new DataResponse(ResponseCode.FAIL.getCode(), e.getMessage(), new ArrayList<>());
                }
            }
        }
        return new DataResponse(ResponseCode.SUCCESS.getCode(), "上传成功", ListApi);
    }
